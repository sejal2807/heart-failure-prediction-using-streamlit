...
st.write("""
    ...
    This app predicts the likelihood of a person having **Heart Attack**
    """
)

st.sidebar.header('Users Medical Records')
st.sidebar.write('please enter your credentials details')
...
try:
    ...
    def user_input_features():
     ...
     creatinine_phosphokinase = st.sidebar.slider('What is the level of Creatinine_Phosphokinase(CP) in your body?', 20,
                                                 8000, 3000)
...
heart_raw = pd.read_csv('dataset//heart_failure_clinical_records_dataset.csv')
...
load_clf = pickle.load(open('heart_failure_model.pickle', 'rb'))
